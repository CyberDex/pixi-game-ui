...
export class Button extends Layout {
    constructor(text: string, onclick: () => void) {
        const button = new FancyButton({
            ...
            text: new Text({
                text: text, // this is a text that will be displayed on the button
                style: {
                    fill: colors.text, // text color
                    fontSize: 55, // text size
                    fontFamily: defaultFont, // text font
                    stroke: { width: 8, color: colors.disabledStroke }, // text stroke color and thickness TODO: change this on button state change
                },
            }),
        ...
        super({
            // create layout with button as content

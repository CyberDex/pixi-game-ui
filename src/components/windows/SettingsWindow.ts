...
export class SettingsWindow extends Window {
    ...
    override createContent() {
        ...
        this.addSwitcher(
            // add SFX switcher to the window
        ...
        this.addSwitcher(
            // add GPU switcher to the window
        ...
        this.addRadio(
            // add antiAliasing switch radio group to the window
        ...
        this.addCheckBox(
            // add subtitles checkbox to the window
        ...
        this.addCheckBox(
            // add cutScenes checkbox to the window
    ...
    private addGFX() {
        this.addContent({
            // add the switcher to the window layout system
            content: {
                // object with the content of the layout ans its styles
                title: {
                    // Content of the ribbon (text)
                ...
                slider: {
                    ...
                    content: {
                        // object with the content of the slider layout ans its styles
                        low: {
                            // Content of the low label (text)
                            content: i18n.titleScreen.settings.low, // string given as a parameter, thar will be turned into a pixi Text
                            styles: {
                                // Styles of the text layout, that will be applied to the pixi Text style too
                                color: 'white', // color of the text
                                fontFamily: defaultFont, // font family of the text
                        ...
                        medium: {
                            // Content of the medium label (text)
                        ...
                        high: {
                            // Content of the high label (text)
                        ...
                        slider: {
                            ...
                            content: new Slider({
                                ...
                                onChange: (value) => {
                                    ...
                                    console.log(
                                        `${i18n.titleScreen.settings.GFX} ${Math.round(value)}`,
                                    ); // log to the console
                                },
                            }),
                            styles: {
                                // styles of the slider layout
    ...
    private addBGM() {
        this.addContent({
            // add the volume control section to the window layout system
            content: {
                // object with the content of the layout ans its styles
                title: {
                    // id of the section text layout
                ...
                soundControl: {
                    // id of the sound control layout
                    content: new DottedProgress({
                        // create a new DottedProgress component (see DottedProgress.ts)
                        steps: 6, // number of steps in the progress bar
                        value: 3, // initial value of the progress bar
                        onChange: (value) => {
                            // callback function that will be called when the progress bar value changes
                            console.log(`${i18n.titleScreen.settings.BGM} ${value}`); // log to the console
                        },
                    }),
                    styles: {
                        // styles of the sound control layout
                        position: 'rightCenter', // place the sound control in the right center of the parent (ribbon layout in this case)
                    },
                },
            },
            styles: {
                // styles of the volume control section layout
    ...
    private addSwitcher(
        ...
        this.addContent({
            // add the checkBox like switches section to the window layout system
            content: {
                // object with the content of the layout ans its styles
                switch: {
                    // id of the switch layout
                    content: gpuCheckbox, // add the switch component to the layout
                    styles: {
                        // styles of the switch layout
            ...
            styles: {
                // styles of the checkBox like switches section layout
    ...
    private addCheckBox(
        ...
        this.addContent({
            // add the checkBox section to the window layout system
            content: {
                // object with the content of the layout ans its styles
                switch: {
                    // id of the switch layout
            ...
            styles: {
                // styles of the checkBox section layout
    ...
    private addRadio(
        ...
        const aniAliasingSelect = items.map(
            (
                item,
                id, // create an array of the radio buttons
            ) =>
                new CheckBox({
                    // create a new CheckBox component (see CheckBox.ts)
        ...
        this.addContent({
            // add the radio buttons section to the window layout system
            aniAliasing: {
                // id of the radio buttons section layout
                content: {
                    // object with the content of the layout ans its styles
                    title: {
                        // id of the title layout
                        content: i18n.titleScreen.settings.antiAliasing, // title text that will be turned into a pixi Text
                        styles: {
                            // Styles of the text also describing pixi Text styles
                            color: 'white', // color of the text
                            fontFamily: defaultFont, // font family of the text
                            fontSize: 60, // font size of the text
                            position: 'leftCenter', // center pixi Text in the middle of parent (ribbon layout in this case)
                    ...
                    switch: {
                        // id of the switch layout
                        content: new RadioGroup({
                            // create a new RadioGroup component (see RadioGroup.ts)
                ...
                styles: {
                    // styles of the radio buttons section layout
